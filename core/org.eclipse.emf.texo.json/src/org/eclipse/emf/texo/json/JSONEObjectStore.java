...
public class JSONEObjectStore extends EObjectStore {
  ...
  protected Collection<EObject> copyAll(List<EObject> aObj) {
    // Copying of references is not supported
    /*
     * ReferenceCopier referenceCopier = new ReferenceCopier(); Collection<EObject> result =
     * referenceCopier.copyAll(aObj); referenceCopier.copyReferences();
     */
    return aObj;
  }
  ...
  public void persist(List<EObject> eObjectsToInsert, List<EObject> eObjectsToUpdate, List<EObject> eObjectsToDelete) {
    ...
    actionType.getDelete().addAll(copyAll(toDelete));
    actionType.getInsert().addAll(copyAll(toInsert));
    actionType.getUpdate().addAll(copyAll(toUpdate));
