...
public class NamedStoredProcedureQueryImpl extends BaseOrmAnnotationImpl implements NamedStoredProcedureQuery {
  ...
  public String toString() {
    ...
    result.append(" (callByIndex: "); //$NON-NLS-1$
    if (callByIndexESet) result.append(callByIndex); else result.append("<unset>"); //$NON-NLS-1$
    result.append(", multipleResultSets: "); //$NON-NLS-1$
    if (multipleResultSetsESet) result.append(multipleResultSets); else result.append("<unset>"); //$NON-NLS-1$
    ...
    result.append(", returnsResultSet: "); //$NON-NLS-1$
    if (returnsResultSetESet) result.append(returnsResultSet); else result.append("<unset>"); //$NON-NLS-1$
    result.append(')');
