...
public class ClubModelPackage extends ModelPackage {
   ...
   * @generated
   */
  public static final String NS_URI = "org.eclipse.emf.texo.test.model.samples.sport.club";
   ...
   * @generated
   */
  public static final int TEAM_MEMBERS_FEATURE_ID = 3;
  ...
  public static ClubModelPackage initialize() {
    ...
    ModelResolver.getInstance().registerClassModelMapping(Gender.class, modelPackage.getGenderEEnum(), modelPackage);
  ...
  /**
   * Returns the {@link EClass} '<em><b>Club</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Club.teams</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Club.teams</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the {@link EClass} '<em><b>Team</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Team.name</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Team.name</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Team.members</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Team.members</b></em>'.
   * @generated
   */
  public EReference getTeam_Members() {
    return (EReference) getTeamEClass().getEAllStructuralFeatures().get(TEAM_MEMBERS_FEATURE_ID);
  }
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Member.name</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Member.name</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Member.lastName</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Member.lastName</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Member.age</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Member.age</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Member.gender</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Member.gender</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the EEnum '<em><b>Gender</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
