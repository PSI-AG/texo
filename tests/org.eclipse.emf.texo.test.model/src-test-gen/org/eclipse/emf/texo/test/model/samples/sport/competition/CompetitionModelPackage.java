...
import org.eclipse.emf.texo.test.model.samples.sport.competition.dao.CompetitionDao;
import org.eclipse.emf.texo.utils.ModelUtils;

/**
 * The <b>Package</b> for the model '<em><b>competition</b></em>'. It contains initialization code and access to the
...
public class CompetitionModelPackage extends ModelPackage {
   ...
   * @generated
   */
  public static final String NS_URI = "org.eclipse.emf.texo.test.model.samples.sport.competition";
   ...
   * @generated
   */
  public static final int COMPETITION_TEAMS_FEATURE_ID = 3;
  ...
  public static CompetitionModelPackage initialize() {
    ...
    DaoRegistry.getInstance().registerDao(Competition.class, CompetitionDao.class);
  ...
  /**
   * Returns the {@link EClass} '<em><b>Competition</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Competition.name</b></em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Competition.name</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Competition.teams</b></em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Competition.teams</b></em>'.
   * @generated
   */
  public EReference getCompetition_Teams() {
    return (EReference) getCompetitionEClass().getEAllStructuralFeatures().get(COMPETITION_TEAMS_FEATURE_ID);
  }
