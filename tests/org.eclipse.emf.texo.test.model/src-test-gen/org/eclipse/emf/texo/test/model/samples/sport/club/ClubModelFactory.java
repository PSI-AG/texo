...
public class ClubModelFactory implements ModelFactory {
  ...
  /**
   * Converts the EDataType: Gender to a String. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
  ...
  /**
   * Creates an instance of the EDataType: Gender from a String. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
