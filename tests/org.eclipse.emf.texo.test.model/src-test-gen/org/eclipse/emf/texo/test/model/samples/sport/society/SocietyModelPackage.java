...
/**
 * The <b>Package</b> for the model '<em><b>society</b></em>'. It contains initialization code and access to the Factory
...
public class SocietyModelPackage extends ModelPackage {
   ...
   * @generated
   */
  public static final String NS_URI = "org.eclipse.emf.texo.test.model.samples.sport.society";
  ...
  public static SocietyModelPackage initialize() {
    ...
    ModelResolver.getInstance().registerClassModelMapping(Society.class, modelPackage.getSocietyEClass(), modelPackage);

    DaoRegistry.getInstance().registerDao(Society.class, SocietyDao.class);
  ...
  /**
   * Returns the {@link EClass} '<em><b>Society</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Society.name</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Society.name</b></em>'.
   * @generated
   */
