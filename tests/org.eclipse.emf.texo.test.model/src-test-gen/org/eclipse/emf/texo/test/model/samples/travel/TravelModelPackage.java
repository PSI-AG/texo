...
/**
 * The <b>Package</b> for the model '<em><b>travel</b></em>'. It contains initialization code and access to the Factory
...
public class TravelModelPackage extends ModelPackage {
  ...
  public static TravelModelPackage initialize() {
    ...
    ModelResolver.getInstance().registerClassModelMapping(Journey.class, modelPackage.getJourneyEClass(), modelPackage);
  ...
  /**
   * Returns the {@link EClass} '<em><b>Journey</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Journey.name</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Journey.name</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Journey.trips</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Journey.trips</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the {@link EClass} '<em><b>Trip</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Trip.name2</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Trip.name2</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Trip.destination</b></em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Trip.destination</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the {@link EClass} '<em><b>City</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>City.name</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>City.name</b></em>'.
   * @generated
   */
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>City.reis</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>City.reis</b></em>'.
   * @generated
   */
