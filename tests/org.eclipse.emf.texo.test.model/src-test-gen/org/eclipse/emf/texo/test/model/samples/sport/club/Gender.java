...
/**
 * A representation of the literals of the enumeration '<em><b>Gender</b></em>'. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public enum Gender {
  ...
  /**
   * An array of all the '<em><b>Gender</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * A public read-only list of all the '<em><b>Gender</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Gender</b></em>' literal with the specified literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param literal
  ...
  /**
   * Returns the '<em><b>Gender</b></em>' literal with the specified name. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param name
  ...
  /**
   * Returns the '<em><b>Gender</b></em>' literal with the specified integer value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value
